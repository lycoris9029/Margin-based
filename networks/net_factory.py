...
from networks.unet import UNet, UNet_DS, UNet_URPC, UNet_CCT, UNet_F
import argparse
from networks.vision_transformer import SwinUnet as ViT_seg
from networks.config import get_config
from networks.nnunet import initialize_network
from networks.projector import projectors,classifier
from networks.unet_SS import UNet as UnetSS
from networks.mcnet import MCNet2d_v1
parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='data/ACDC', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='ACDC/My_model', help='experiment_name')
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    if net_type == "unet":
        ...
        net = projectors(in_chns).cuda()
    elif net_type == 'unet-SS':
        net = UnetSS(in_chns,class_num).cuda()
